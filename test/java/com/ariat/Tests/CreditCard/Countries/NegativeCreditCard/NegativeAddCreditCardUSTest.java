...
public class NegativeAddCreditCardUSTest extends BaseTest {
	...
	public void negativeAddCreditCardTestBE() {
		...
		addACreditCardPage.setDetailsCreditCardUS(CARD_ID, CARD_OWNER, "dghdfjghdfkghdf", typeCard.VISA.getCvs(), MONTH, YEAR);
	...
	public void negativeAddCreditCardTestWildCardBE() {
		...
		myAccountPage = signInPage.returnMyAccountPage();
		addACreditCardPage = myAccountPage.returnAddACreditCardMiddleNav();
		addACreditCardPage.setDetailsCreditCardUS(CARD_IDWILD, CARD_OWNERWILD, "@#$%^&*(", typeCard.VISA.getCvs(), MONTH, YEAR);
		paymentInfoPage = addACreditCardPage.returnPaymentInformationPage();
		paymentInfoPage.checkCreditCard(CARD_OWNER, typeCard.VISA.getName(), expirationDate);
		logger.info("Finishing add negative credit card Belgium test");
	}
	...
	public void negativeAddCreditCardTestMissingValuesBE() {
		...
		myAccountPage = signInPage.returnMyAccountPage();
		addACreditCardPage = myAccountPage.returnAddACreditCardMiddleNav();
		addACreditCardPage.setDetailsCreditCardUS(null, null,typeCard.VISA.getName(), null, YEAR, MONTH);
		paymentInfoPage = addACreditCardPage.returnPaymentInformationPage();
		paymentInfoPage.checkCreditCard(CARD_OWNER, typeCard.VISA.getName(), expirationDate);
		logger.info("Finishing add negative credit card Belgium test");
	}
	...
	public void negativeAddCreditCardTestExpirationDateBE() {
		...
		myAccountPage = signInPage.returnMyAccountPage();
		addACreditCardPage = myAccountPage.returnAddACreditCardMiddleNav();
		addACreditCardPage.setDetailsCreditCardUS(CARD_ID, CARD_OWNER, typeCard.VISA.getName(), typeCard.VISA.getCvs(), MONTH1, YEAR1);
		paymentInfoPage = addACreditCardPage.returnPaymentInformationPage();
		paymentInfoPage.checkCreditCard(CARD_OWNER, typeCard.VISA.getName(), expirationDate);
